...
| What | Count |
|---|---|
| News events read | 148,802 |
| Event → contract links | 294,782 |
| Model verdicts | 67,692 |
| Contracts with a settled outcome | 7,636 |
| Price points recorded | 651,586 |
| Paper trades / refusals | 76 / 344,847 |
