...
| What | Count |
|---|---|
| News events read | 190,004 |
| Event → contract links | 387,718 |
| Model verdicts | 114,537 |
| Contracts with a settled outcome | 9,555 |
| Price points recorded | 817,622 |
| Paper trades / refusals | 79 / 445,285 |
...
Total closed 74, net +$22.14. Weather's plus is one +$95 trade on a 12-trade sample. `no-bias` was switched off on 2026-09-13 after 1 hit in 6: the overpricing it was built on did not hold out of sample. Neither is an edge; we say so.

**Market calibration, our own data (all categories, price ~24 h before close):**

| Price band | n | Avg price | YES resolved | YES − price |
|---|---|---|---|---|
| 0-10¢ | 1381 | 0.8¢ | 0.5% | -0.3pp |
