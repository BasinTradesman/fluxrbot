...
| What | Count |
|---|---|
| News events read | 165,954 |
| Event → contract links | 334,395 |
| Model verdicts | 91,762 |
| Contracts with a settled outcome | 8,363 |
| Price points recorded | 714,767 |
| Paper trades / refusals | 76 / 389,577 |
