...
| What | Count |
|---|---|
| News events read | 196,293 |
| Event → contract links | 404,889 |
| Model verdicts | 125,377 |
| Contracts with a settled outcome | 9,767 |
| Price points recorded | 844,320 |
| Paper trades / refusals | 79 / 464,054 |
