...
| What | Count |
|---|---|
| News events read | 170,364 |
| Event → contract links | 344,969 |
| Model verdicts | 91,762 |
| Contracts with a settled outcome | 8,509 |
| Price points recorded | 730,888 |
| Paper trades / refusals | 78 / 400,293 |
