...
| What | Count |
|---|---|
| News events read | 152,703 |
| Event → contract links | 304,009 |
| Model verdicts | 73,810 |
| Contracts with a settled outcome | 7,891 |
| Price points recorded | 667,129 |
| Paper trades / refusals | 76 / 354,379 |
