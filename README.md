...
| What | Count |
|---|---|
| News events read | 184,088 |
| Event → contract links | 372,917 |
| Model verdicts | 106,127 |
| Contracts with a settled outcome | 9,313 |
| Price points recorded | 796,172 |
| Paper trades / refusals | 79 / 429,637 |
