...
| What | Count |
|---|---|
| News events read | 171,354 |
| Event → contract links | 347,456 |
| Model verdicts | 91,762 |
| Contracts with a settled outcome | 8,537 |
| Price points recorded | 735,471 |
| Paper trades / refusals | 78 / 402,810 |
