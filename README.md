...
| What | Count |
|---|---|
| News events read | 169,109 |
| Event → contract links | 341,967 |
| Model verdicts | 91,762 |
| Contracts with a settled outcome | 8,486 |
| Price points recorded | 726,434 |
| Paper trades / refusals | 78 / 397,246 |
