...
| What | Count |
|---|---|
| News events read | 178,042 |
| Event → contract links | 359,283 |
| Model verdicts | 97,163 |
| Contracts with a settled outcome | 8,939 |
| Price points recorded | 769,912 |
| Paper trades / refusals | 78 / 415,350 |
