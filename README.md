...
| What | Count |
|---|---|
| News events read | 195,565 |
| Event → contract links | 402,873 |
| Model verdicts | 123,965 |
| Contracts with a settled outcome | 9,725 |
| Price points recorded | 839,794 |
| Paper trades / refusals | 79 / 462,025 |
