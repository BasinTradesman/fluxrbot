...
| What | Count |
|---|---|
| News events read | 192,292 |
| Event → contract links | 393,867 |
| Model verdicts | 118,309 |
| Contracts with a settled outcome | 9,608 |
| Price points recorded | 826,282 |
| Paper trades / refusals | 79 / 451,779 |
