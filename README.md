...
| What | Count |
|---|---|
| News events read | 151,349 |
| Event → contract links | 300,843 |
| Model verdicts | 71,838 |
| Contracts with a settled outcome | 7,873 |
| Price points recorded | 662,809 |
| Paper trades / refusals | 76 / 351,190 |
