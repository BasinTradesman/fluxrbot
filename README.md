...
| What | Count |
|---|---|
| News events read | 173,050 |
| Event → contract links | 350,673 |
| Model verdicts | 91,762 |
| Contracts with a settled outcome | 8,634 |
| Price points recorded | 743,569 |
| Paper trades / refusals | 78 / 406,119 |
