...
| What | Count |
|---|---|
| News events read | 193,257 |
| Event → contract links | 396,276 |
| Model verdicts | 119,892 |
| Contracts with a settled outcome | 9,650 |
| Price points recorded | 830,177 |
| Paper trades / refusals | 79 / 454,214 |
