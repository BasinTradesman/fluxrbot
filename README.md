...
| What | Count |
|---|---|
| News events read | 198,097 |
| Event → contract links | 409,352 |
| Model verdicts | 128,132 |
| Contracts with a settled outcome | 9,928 |
| Price points recorded | 852,091 |
| Paper trades / refusals | 79 / 468,757 |
